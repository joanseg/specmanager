...
updatedAt: '2026-06-02T11:27:35.778Z'
---
## Problem
...
1. **Wide mockups.** If a design brief's own HTML is genuinely wider than the panel
   ...
   _inside_ the iframe (intentional), scale-to-fit, or clip? The goal of "no horizontal
   ...
   Answer: correct
1. **Scrollbar styling parity.** Does parity require matching custom scrollbar styling
   ...
   Answer: width and color across both viewers
1. **Verification.** Is there a representative wide design brief in the repo to test
   against, or should one be constructed for QA?

   Answer: contruct one on design phase.
